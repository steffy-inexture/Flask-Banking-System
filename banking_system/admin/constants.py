...
ROLE_IS_OCCUPIED = "This role is occupied by some bank member you can not delete that."
LOAN_CHOICE_ALREADY_EXIST = "This loan choice is already exist"
NEW_LOAN_CHOICE_ADDED = "New loan Choice has been added"
LOAN_CHOICE_DELETED = "Desired Loan choice has been deleted from the list successfully"
LOAN_CHOICE_IS_OCCUPIED = "Loan choice is occupied with some user you can not delete this"
...
INSURANCE_CHOICE_DELETED = "Desired Insurance choice has been deleted from the list successfully"
INSURANCE_CHOICE_IS_OCCUPIED = "Insurance choice is occupied with some user you can not delete this"
